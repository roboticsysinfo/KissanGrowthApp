    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.settingListContainer}>
        ...
        <List.Section>
          ...
          <List.Item  title="Orders" left={() => <Icon name="shopping" size={24} />} right={() => <Icon name="chevron-right" size={24} />} onPress={() => {}} />
          ...
          <List.Item  title="Notifications" left={() => <Icon name="bell" size={24} />} right={() => <Icon name="chevron-right" size={24} />} onPress={() => {}} />
